      ...
      <div className="py-6 space-y-8">
        <div className="bg-light rounded-xl py-8">
          ...
          <div className="font-title mx-4 sm:mx-6 rounded border-dark border [&>div]:px-6 my-4">
            ...
            <div className="text-right text-2xl border-b border-dark">12</div>
            <div className="text-lg pt-2">Estimated Reward</div>
            <div className="text-right text-2xl">$12,340</div>
          </div>
