...
export default function Page() {
  ...
  return (
    <main className="md:grid md:grid-cols-12 flex flex-col gap-4 md:p-10">
      <div className="md:col-span-4 px-10 flex flex-col gap-4">
        ...
        <div>
          ...
          <p className="text-xl font-md">
            ...
            perspiciatis error molestias voluptas ducimus quaerat nemo deleniti!
            Debitis magni sequi commodi repudiandae.
          </p>
        </div>
      </div>
